...
public class ChapterAdapter extends RecyclerView.Adapter {
    ...
    public ChapterAdapter(ArrayList<MessagesModel> messagesModels, Context context) {
        this.messagesModels = messagesModels;
        this.context = context;
    }

    public ChapterAdapter(ArrayList<MessagesModel> messagesModels, Context context, String recId) {
        this.messagesModels = messagesModels;
        this.context = context;
        this.recId = recId;
    }
    ...
    public class ReceiverViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView receiverTime, receiverMsg;
