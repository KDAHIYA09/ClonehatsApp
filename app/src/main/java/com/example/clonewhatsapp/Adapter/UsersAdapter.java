...
import com.example.clonewhatsapp.CHATDetailActivityy;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.viewHolder> {
    ...
    public void onBindViewHolder(@NonNull UsersAdapter.viewHolder holder, int position) {
        ...
        Picasso .get().load(users.getProfilePic()).placeholder(R.drawable.avvvatar).into(holder.image);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, CHATDetailActivityy.class);
                intent.putExtra("usedId", users.getUserID());
